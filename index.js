...
export default class XG {
    ...
    static setReportNotificationStatusEnable(debugMode) {
        Test.setReportNotificationStatusEnable(debugMode)
    }
    ...
    static setReportApplistEnable(debugMode) {
        Test.setReportApplistEnable(debugMode)
    }
    ...
    static setHuaweiDebug(isHuaweiDebug) {
        Test.setHuaweiDebug(isHuaweiDebug)
    }
    ...
    static registerPushAccountCallback(account) {
        Test.registerPushAccountCallback(account)
    }
    ...
    static registerPushWithLogin(account, ticket, ticketType, qua) {
        Test.registerPushWithLogin(account, ticket, ticketType, qua)
    }
    ...
    static bindAccountCallback(account) {
        return new Promise((resolve, reject) => {
            try {
                Test.bindAccountCallback(account)
            } catch (e) {
                reject(e)
            }
    ...
    static appendAccountCallback(account) {
        return new Promise((resolve, reject) => {
            try {
                Test.appendAccountCallback(account)
            } catch (e) {
                reject(e)
            }
    ...
    static delAccountCallback(account) {
        return new Promise((resolve, reject) => {
            try {
                Test.delAccountCallback(account)
            } catch (e) {
                reject(e)
            }
     ...
     */
     ...
     static seTestNotificationBuilder(notificationBulderId,options){
         Test.seTestNotificationBuilder(notificationBulderId,options)
     }
     ...
     * 检测通知栏是否关闭
     */
    static isNotificationOpened(cd) {
        try {
            Test.isNotificationOpened()
        } catch (e) {
            reject(e)
        }
     ...
     * 注册回调
     */
    static addRegisterResultListener(cb) {
        listeners[cb] = DeviceEventEmitter.addListener(
            "registerResult",
            map => {
              cb(map)
     ...
     * 反注册回调
     */
    static addUnregisterResultListener(cb) {
        listeners[cb] = DeviceEventEmitter.addListener(
            "unRegisterResult",
            map => {
              cb(map)
     ...
     * 设置标签回调
     */
    static addSetTagResultListener(cb) {
        listeners[cb] = DeviceEventEmitter.addListener(
            "setTagResult",
            map => {
              cb(map)
     ...
     * 删除标签回调
     */
    static addDeleteTagResultListener(cb) {
        listeners[cb] = DeviceEventEmitter.addListener(
            "deleteTagResult",
            map => {
              cb(map)
     ...
     * 应用内消息的回调
     */
    static addTextMessageListener(cb) {
        listeners[cb] = DeviceEventEmitter.addListener(
            "textMessage",
            map => {
              cb(map)
     ...
     * 通知被点击触发的回调
     */
    static addNotifactionClickedResultListener(cb) {
        listeners[cb] = DeviceEventEmitter.addListener(
            "notificationClickedResult",
            map => {
              cb(map)
            }
        )
     ...
     */
    static addNotifactionShowedResult(cb) {
        listeners[cb] = DeviceEventEmitter.addListener(
            "notificationShowedResult",
            map => {
              cb(map)
            }
        )
